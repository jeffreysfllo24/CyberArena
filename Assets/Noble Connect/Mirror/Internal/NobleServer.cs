...
namespace NobleConnect.Mirror
{
    ...
    public class NobleServer
    {
        ...
        static public bool ReplacePlayerForConnection(NetworkConnectionToClient conn, GameObject player, Guid assetId, bool keepAuthority = false)
        {
        ...
        static public bool AddPlayerForConnection(NetworkConnectionToClient conn, GameObject player, Guid assetId)
        {
