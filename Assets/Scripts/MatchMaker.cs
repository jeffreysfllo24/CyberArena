...
namespace MirrorBasics {
    ...
    public class Match {
        ...
        public Match (string matchID, PlayerManager player, bool publicMatch) {
            matchFull = false;
            inMatch = false;
    ...
    public class MatchMaker : NetworkBehaviour {
        ...
        public bool HostGame (string _matchID, PlayerManager _player, bool publicMatch, out int playerIndex) {
            playerIndex = -1;
        ...
        public bool SearchGame (PlayerManager _player, out int playerIndex, out string matchID) {
            playerIndex = -1;
            matchID = "";
